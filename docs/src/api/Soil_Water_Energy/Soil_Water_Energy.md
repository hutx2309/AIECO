...
module. It currently establishes the module boundary; the pure-equation and
process-function scripts listed below have not yet been included into it.
...
- Add process/state orchestration only after the pure and process functions are
  tested.
